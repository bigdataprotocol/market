...
function getConsumeHelpText(
  ...
  const text =
    isConsumable === false
      ...
      : hasDatatoken
      ? `You own ${dtBalance} ${dtSymbol} allowing you to use this data set by spending 1 ${dtSymbol}, but without paying BDP again.`
      : lowPoolLiquidity
      ? `There are not enought ${dtSymbol} available in the pool for the transaction to take place`
      : isBalanceSufficient === false
      ? 'You do not have enough BDP in your wallet to purchase this asset.'
...
function getComputeAssetHelpText(
  ...
  const computeAlgoHelpText =
    ...
    isConsumable === false
      ...
      ? `You own ${dtBalanceSelectedComputeAsset} ${dtSymbolSelectedComputeAsset} allowing you to use the selected ${selectedComputeAssetType} by spending 1 ${dtSymbolSelectedComputeAsset}, but without paying BDP again.`
